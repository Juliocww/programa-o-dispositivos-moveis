...
<View style={styles.appBar}>
  <Text style={styles.appTitle}>Eu e vc nunk</Text>
</View>
...
const styles = StyleSheet.create({
    ...
    item: { backgroundColor: "#FEF7FF", height: 72, borderBottomWidth: 1, borderBottomColor: "#79747E", paddingTop: 8, paddingLeft: 16, paddingRight: 16, paddingBottom: 8, },
